      ...
      <div className="max-w-[1431px] w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-4 text-left">
            ...
            <p className="font-['Inter',sans-serif] font-normal text-sm text-slate-300 leading-relaxed mb-6">
          ...
          <div className="lg:col-span-2 text-left">
            ...
            <ul className="space-y-3 font-['Inter',sans-serif] text-sm text-slate-300">
              ...
              <li><a href="#news" className="hover:text-[#0941DC] transition-colors">News & Ideas</a></li>
        ...
        <div className="py-10 flex flex-col lg:flex-row items-center justify-between gap-8 border-b border-white/10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-[7px] border border-white/10 bg-[#080816] hover:border-[#0941DC]/50 transition-all select-none shadow-md">
              ...
              <div className="text-left">
                <div className="text-[10px] font-bold text-sky-400 tracking-wider font-['Inter',sans-serif]">META BUSINESS</div>
                <div className="text-xs font-bold text-white font-['Inter',sans-serif]">Creative Strategist</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-[7px] border border-white/10 bg-[#080816] hover:border-[#0941DC]/50 transition-all select-none shadow-md">
              ...
              <div className="text-left">
                <div className="text-[10px] font-bold text-sky-400 tracking-wider font-['Inter',sans-serif]">GOOGLE ADS</div>
                <div className="text-xs font-bold text-white font-['Inter',sans-serif]">Partner Certified</div>
              </div>
            </div>
